...
import { JsonExtraPostType, JsonExtraType } from '../types'
...
type ParamsType = { city: string | null | undefined; language: string | null | undefined; };

export default (baseUrl: string): Endpoint<ParamsType, Array<ExtraModel>> => new EndpointBuilder<ParamsType, Array<ExtraModel>>(EXTRAS_ENDPOINT_NAME)
  ...
  }).withMapper((json: Array<JsonExtraType>) => json.map(extra => new ExtraModel({
    alias: extra.alias,
    title: extra.name,
    path: extra.url,
