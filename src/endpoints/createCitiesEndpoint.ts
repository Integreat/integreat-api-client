...
export default (baseUrl: string): Endpoint<void, Array<CityModel>> => new EndpointBuilder<void, Array<CityModel>>(CITIES_ENDPOINT_NAME)
  ...
  })).sort((city1, city2) => city1.sortingName.localeCompare(city2.sortingName))).build()
