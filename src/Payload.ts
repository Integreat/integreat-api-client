...
class Payload<T> {
  ...
  constructor (isFetching: boolean, requestUrl: string | null | undefined = null, data: T | null | undefined = null, error: Error | null | undefined = null, fetchDate: number = Date.now()) {
