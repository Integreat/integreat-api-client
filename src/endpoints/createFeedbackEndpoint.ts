...
export default ((baseUrl: string): Endpoint<ParamsType, {}> => new EndpointBuilder<ParamsType, {}>(FEEDBACK_ENDPOINT_NAME)
  .withParamsToUrlMapper(params => {
  return `${baseUrl}/${params.city}/${params.language}/wp-json/extensions/v3/feedback${params.feedbackType ? `/${params.feedbackType}` : ''}`
